...
class Utils extends Controller
{
    ...
    public function gethead($url, $header)
    {
        $ch = curl_init($url);
    ...
    public function importSQLFile($connection)
    {
    ...
    public function delete_bd_user()
    {
        $id              = $_POST['id'];
        $connectDatabase = connectDatabase();
    ...
    public function setCurl($ch, array $header)
    {
        $options = array(
    ...
    public function switch_bd_user()
    {
        $id              = $_POST['id'];
        $switch          = $_POST['switch'];
    ...
    public function UpdateCookieTime($id)
    {
        $currentDateTime = date('Y-m-d H:i:s');
    ...
    public function extractStr($str, $left, $right)
    {
